...
return [
    ...
    */
    ...
    'include' => [
        __DIR__.'/../src/DeploymentRecipes/backup.php',
        __DIR__.'/../src/DeploymentRecipes/config.php',
        __DIR__.'/../src/DeploymentRecipes/forge.php',
        __DIR__.'/../src/DeploymentRecipes/sentry.php'
    ],
